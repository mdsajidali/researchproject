...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 2000, 2000, 100.0, 0.6945000000000016, 0, 360, 0.0, 1.0, 1.0, 8.0, 89.8311174991017, 97.7044991353755, 0.0], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["GET Home", 500, 500, 100.0, 0.3540000000000001, 0, 92, 0.0, 0.0, 0.0, 3.990000000000009, 22.479992806402304, 24.346007834277493, 0.0], "isController": false}, {"data": ["POST Login", 500, 500, 100.0, 0.6200000000000006, 0, 50, 0.0, 1.0, 2.0, 13.980000000000018, 22.47797158784391, 24.47552570356051, 0.0], "isController": false}, {"data": ["GET Expenses", 500, 500, 100.0, 0.09, 0, 11, 0.0, 0.0, 0.0, 2.0, 22.487069934787495, 24.551312682707444, 0.0], "isController": false}, {"data": ["POST Add Expense", 500, 500, 100.0, 1.7140000000000002, 0, 360, 0.0, 1.0, 2.0, 12.990000000000009, 22.487069934787495, 24.441512536541488, 0.0], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
