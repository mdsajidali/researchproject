...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 2000, 2000, 100.0, 0.08449999999999994, 0, 9, 0.0, 0.0, 1.0, 1.0, 207.08221163802028, 225.03001074238975, 0.0], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["GET Home", 500, 500, 100.0, 0.02799999999999998, 0, 1, 0.0, 0.0, 0.0, 1.0, 51.80810278727593, 56.05798621904466, 0.0], "isController": false}, {"data": ["POST Login", 500, 500, 100.0, 0.13800000000000007, 0, 9, 0.0, 1.0, 1.0, 1.0, 51.86184005808526, 56.42000959444041, 0.0], "isController": false}, {"data": ["GET Expenses", 500, 500, 100.0, 0.019999999999999993, 0, 1, 0.0, 0.0, 0.0, 1.0, 51.92107995846314, 56.63656866562824, 0.0], "isController": false}, {"data": ["POST Add Expense", 500, 500, 100.0, 0.1520000000000001, 0, 4, 0.0, 1.0, 1.0, 1.0, 51.948051948051955, 56.41233766233766, 0.0], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
